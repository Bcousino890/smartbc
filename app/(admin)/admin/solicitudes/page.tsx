...
export default function AdminSolicitudesPage() {
  ...
  const filtered = useMemo(() => {
    ...
    if (!q) return mockVisitRequests;
    return mockVisitRequests.filter(
      (r) =>
            ...
            <thead>
              <tr className="text-[10px] font-semibold uppercase tracking-[0.14em] text-ink/50">
                <th className="px-3 pb-2">
                  {t("solicitudes.table.client")}
                </th>
                <th className="px-3 pb-2">
                  {t("solicitudes.table.property")}
                </th>
                <th className="px-3 pb-2">
                  {t("solicitudes.table.requestedDate")}
                </th>
                <th className="px-3 pb-2">
                  {t("solicitudes.table.channel")}
                </th>
                <th className="px-3 pb-2">
                  {t("solicitudes.table.advisor")}
                </th>
                <th className="px-3 pb-2">
                  {t("solicitudes.table.received")}
                </th>
                <th className="px-3 pb-2">
                  {t("solicitudes.table.status")}
                </th>
                <th className="px-3 pb-2 text-right">
                  {t("solicitudes.table.actions")}
                </th>
              </tr>
            </thead>
            <tbody>
