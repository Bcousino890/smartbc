...
export default function AdminPropiedadesPage() {
  ...
  const filtered = useMemo(() => {
    ...
    if (!q) return mockAdminProperties;
    return mockAdminProperties.filter(
      (p) =>
