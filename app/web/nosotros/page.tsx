        ...
        <div>
          ...
          <div className="mt-10 border-l-2 border-gold pl-6 py-2">
            ...
            <p className="mt-3 text-navy/80 leading-relaxed">
              Serrano · Ortega y Gasset · Lagasca · Jorge Juan. Si en Santiago conoce Vitacura o El Golf, en Madrid esto es su equivalente directo.
            </p>
          </div>
        </div>
      </section>
        ...
        <div className="mt-16 grid md:grid-cols-3 gap-px bg-stone-200">
          {[
            ...
            <div key={s.n} className="bg-cream p-10">
              ...
              <p className="mt-4 text-sm text-gray-500 leading-relaxed">{s.d}</p>
            </div>
          ))}
        </div>
      </section>
          ...
          <div className="mt-14 grid md:grid-cols-2 gap-px bg-stone-200">
            {[
              ...
              <div key={o.city} className="bg-cream p-12">
                ...
                <p className="text-sm text-gray-500">{o.line2}</p>
                <a href={`tel:${o.phone.replace(/\s/g, "")}`} className="block mt-6 font-display text-2xl text-navy hover:text-gold">{o.phone}</a>
                <p className="mt-2 text-[11px] tracking-[0.22em] uppercase text-gray-400">{o.hours}</p>
              </div>
            ))}
          </div>
        </div>
