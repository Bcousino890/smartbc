  ...
  return (
    <div className="relative min-h-screen bg-cream-50">
      ...
      <div className="relative z-10">
        <AdminSidebar user={adminUser} currentRole={profile.role} permissions={permissions} pendingVisits={pendingVisits ?? 0} unreadMessages={unreadMessages} country="es" canSwitchCountry={profile.role === "owner" || profile.role === "admin"} />
