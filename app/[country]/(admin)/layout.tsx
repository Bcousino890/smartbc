...
export default async function AdminLayout({
  ...
  // Árbol dinámico único para es/cl (fase 4 del refactor, ver
  // CHILE_CRM_ANALISIS.md). Cualquier otro segmento (p.ej. /fr/admin) no
  // existe: 404 en vez de renderizar contenido de un país inválido.
  ...
  return (
    <div className="relative min-h-screen bg-cream-50">
      ...
      <div className="relative z-10">
        <AdminSidebar user={adminUser} currentRole={profile.role} permissions={permissions} pendingVisits={pendingVisits ?? 0} unreadMessages={unreadMessages} unreadNotifications={unreadNotifications} country={country} canSwitchCountry={canSwitchCountry} />
