        ...
        <dl className="mt-3 grid grid-cols-2 gap-x-4 gap-y-3 text-[13px]">
          ...
          {(client.budgetMin > 0 || client.budgetMax > 0) && (
            <PrefItem
              ...
              value={`${config.formatPrice(client.budgetMin)} – ${config.formatPrice(client.budgetMax)}`}
            />
          )}
          <PrefItem
              ...
              >
                <div className="flex min-w-0 items-center gap-2.5">
                  ...
                  <div className="min-w-0">
                    {visit.propertySlug ? (
                      <Link
                        href={`${config.prefix}/propiedades/${visit.propertySlug}`}
