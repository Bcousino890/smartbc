  ...
  return (
    <section className="rounded-2xl border border-gold/15 bg-cream-50/85 p-5 shadow-[0_15px_40px_-25px_rgba(40,28,10,0.20)] backdrop-blur-sm md:p-6">
      <header className="flex flex-wrap items-center justify-between gap-3">
        <h2 className="crm-label-sm text-ink/55">
          {t("agency.properties.title")}
        </h2>
        <Link
          href="/admin/propiedades"
          className="flex items-center gap-1.5 text-xs font-medium text-gold-dark transition hover:text-gold"
        >
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2 text-xs">
          ...
          {hasActiveFilters && (
            <button
              ...
              className="rounded-md border border-ink/15 bg-white px-2.5 py-1 text-xs font-medium text-ink/65 transition hover:border-rose-300 hover:text-rose-700"
            >
              Limpiar filtros
            </button>
          )}
      ...
      {selected.size > 0 && (
        <div className="mt-3 flex flex-wrap items-center gap-2 rounded-xl border border-gold/35 bg-gold/10 px-3 py-2">
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-emerald-300 bg-emerald-50 px-3 py-1.5 text-xs font-medium text-emerald-700 transition hover:bg-emerald-100"
          >
          ...
          <button
            ...
            className="inline-flex items-center gap-1.5 rounded-lg border border-ink/15 bg-white px-3 py-1.5 text-xs font-medium text-ink/65 transition hover:border-rose-300 hover:text-rose-700"
          >
  ...
  return (
    ...
    >
      ...
      <td className="px-4 py-3">
        <span
          className={cn(
            "rounded-md border px-2.5 py-1 crm-label-sm",
            isRent
      ...
      <td className="rounded-r-xl px-4 py-3 text-right">
        <Link
          ...
          className="inline-flex items-center gap-2 rounded-lg bg-ink px-3.5 py-2 text-xs font-medium text-cream-50 transition hover:bg-ink-soft"
        >
