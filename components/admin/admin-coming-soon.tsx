...
export function AdminComingSoon({
  ...
  return (
    <div className="mx-auto flex min-h-screen max-w-[1200px] flex-col px-6 pb-10 lg:px-10">
      <AdminPageHeader titleKey={titleKey} subtitleKey={subtitleKey} />

      <div className="mt-12 flex flex-1 items-center justify-center">
        <div className="rounded-2xl border border-gold/25 bg-cream-50/85 px-10 py-12 text-center shadow-[0_20px_60px_-25px_rgba(40,28,10,0.30)] backdrop-blur-sm">
