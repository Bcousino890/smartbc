    ...
    <footer className="bg-navy text-cream/90 mt-24">
      <div className="container-luxe py-20 grid gap-12 md:grid-cols-4">
        <div className="md:col-span-2 max-w-md">
          ...
          <p className="mt-8 font-display italic text-2xl leading-snug text-cream/90">
      ...
      <div className="border-t border-cream/10">
        <div className="container-luxe py-6 flex flex-col md:flex-row justify-between items-center gap-4 text-[11px] tracking-[0.22em] uppercase text-cream/50">
          ...
          <div className="flex gap-8">
            <Link to="/propiedades" className="hover:text-gold">Propiedades</Link>
            <Link to="/off-market" className="hover:text-gold">Off Market</Link>
            <Link to="/nosotros" className="hover:text-gold">Nosotros</Link>
