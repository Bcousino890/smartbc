...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      { title: "Benjamín Cousiño Propiedades — Vidas Extraordinarias en Lugares Excepcionales" },
      { name: "description", content: "Personal shopper inmobiliario de lujo en España y Chile. Acceso a 1.800+ propiedades off market en Madrid, Santiago, Marbella, Costa Brava y más." },
      { property: "og:title", content: "Benjamín Cousiño Propiedades" },
      { property: "og:description", content: "Vidas extraordinarias en lugares excepcionales — España y Chile." },
  ...
  return (
    <div>
      ...
      <section className="relative min-h-[92vh] flex items-end overflow-hidden">
        <img src={heroVilla} alt="Villa de lujo frente al mar" className="absolute inset-0 h-full w-full object-cover" width={1920} height={1280} />
        ...
        <div className="container-luxe relative z-10 pb-24 pt-40">
          ...
          <div className="mt-10 flex flex-wrap gap-4">
            <Link to="/propiedades" className="bg-navy text-cream px-8 py-4 text-[11px] tracking-[0.28em] uppercase hover:bg-gold hover:text-navy transition-colors">
              Ver Propiedades
            </Link>
            <Link to="/off-market" className="border border-navy/30 text-navy px-8 py-4 text-[11px] tracking-[0.28em] uppercase hover:bg-navy hover:text-cream transition-colors inline-flex items-center gap-3">
      ...
      {/* QUICK SEARCH */}
      <section className="bg-cream-deep border-y border-border/60">
        <div className="container-luxe py-10 grid md:grid-cols-[1fr_auto] items-center gap-8">
          ...
          <Link to="/off-market" className="text-[11px] tracking-[0.28em] uppercase text-gold hover:text-navy inline-flex items-center gap-2">
      ...
      <section className="bg-cream-deep py-28">
        <div className="container-luxe">
          <div className="flex flex-col md:flex-row md:items-end md:justify-between gap-6">
            ...
            <Link to="/propiedades" className="text-[11px] tracking-[0.28em] uppercase text-gold hover:text-navy inline-flex items-center gap-2">
      ...
      <section className="relative py-32 overflow-hidden">
        ...
        <div className="container-luxe relative z-10 max-w-4xl text-center text-cream">
          ...
          <p className="mt-8 text-cream/80 max-w-2xl mx-auto leading-relaxed">
            Nuestra cartera off market incluye residencias, villas y pisos premium en Santiago, Madrid, Costa Brava y otras ubicaciones exclusivas. Propiedades que los propietarios prefieren mantener en absoluta discreción.
          </p>
          <div className="mt-10 flex flex-wrap justify-center gap-4">
            <Link to="/off-market" className="bg-gold text-navy px-8 py-4 text-[11px] tracking-[0.28em] uppercase hover:bg-cream transition-colors">Solicitar Acceso Privado</Link>
            <Link to="/contacto" className="border border-cream/40 text-cream px-8 py-4 text-[11px] tracking-[0.28em] uppercase hover:bg-cream hover:text-navy transition-colors">Hablar con Asesor</Link>
          </div>
        </div>
      </section>
      ...
      <section className="container-luxe py-28">
        ...
        <blockquote className="mt-20 text-center font-display italic text-4xl md:text-6xl text-navy leading-tight">
          "Nos adaptamos a ti.<br />No al revés."
        </blockquote>
      </section>
        ...
        <div className="container-luxe grid lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="mt-8 text-cream/80 leading-relaxed">
              Trabajamos con clientes de más de diez países que llegan a España o Chile por estudios, trabajo, diplomacia o familia. Conocemos su cultura, entendemos sus expectativas y garantizamos una reubicación sin fricciones.
            </p>
            <p className="mt-4 text-cream/70 leading-relaxed">
              Sin barreras de idioma. Sin malentendidos culturales. Nos adaptamos completamente a ti — no al revés.
            </p>
          ...
          <div>
            ...
            <p className="mt-3 text-cream/80 font-display italic text-xl leading-relaxed">
              Italia · Rumanía · Turquía · Argentina · Reino Unido · Francia · Portugal · Suiza · Países Bajos · Bélgica · Austria · Suecia · Noruega · Dinamarca · Irlanda · Luxemburgo · Mónaco · Emiratos Árabes Unidos · Arabia Saudita · Catar · Israel · Singapur · Japón · Corea del Sur · China · Hong Kong · Australia · Canadá · Brasil · Perú · Uruguay · Venezuela · Ecuador · Panamá · Costa Rica · República Dominicana · Polonia · República Checa · Grecia · Sudáfrica · India
            </p>
          </div>
        </div>
      ...
      <section className="py-24 bg-cream">
        <div className="container-luxe text-center">
          ...
          <p className="mt-4 text-muted-foreground max-w-2xl mx-auto">
            Ayudamos a estudiantes, profesores e investigadores internacionales a encontrar su hogar en Madrid.
          </p>
        </div>
        <div className="mt-16 overflow-hidden relative">
          ...
          <div className="flex gap-px bg-border/50 animate-marquee w-max">
            {[...universities, ...universities].map((u, i) => {
              const [main, sub] = u.name.split(/\s—\s|\s·\s/);
              return (
                <div
                  key={i}
                  className="bg-cream w-60 h-32 px-6 flex flex-col items-center justify-center shrink-0 border-t border-b border-navy/5 group"
                  title={u.name}
                >
                  ...
                  {sub && (
                    <span className="mt-1 text-[10px] tracking-[0.22em] uppercase text-navy/50 text-center">
                      {sub}
                    </span>
                  )}
        ...
        <div className="container-luxe grid lg:grid-cols-12 gap-16 items-center">
          <div className="lg:col-span-7">
            ...
            <p className="mt-8 text-cream/80 leading-relaxed max-w-2xl">
              Trabajamos junto a despachos de abogados, family offices, consultoras de movilidad internacional, agencias inmobiliarias, brokers, relocators, head-hunters y departamentos de RR.HH. Actuamos como tu proveedor de propiedades premium y off-market en España y Chile, atendiendo a tus clientes y ejecutivos con discreción absoluta y estándares editoriales.
            </p>
      ...
      <section className="container-luxe py-28 max-w-4xl">
        ...
        <div className="mt-12 text-center">
          <Link to="/contacto" className="text-[11px] tracking-[0.28em] uppercase text-gold hover:text-navy inline-flex items-center gap-2">
      ...
      <section className="bg-navy text-cream py-32 text-center">
        <div className="container-luxe max-w-3xl">
          ...
          <Link to="/contacto" className="mt-10 inline-block bg-gold text-navy px-10 py-4 text-[11px] tracking-[0.28em] uppercase hover:bg-cream transition-colors">
...
function Faq({ q, a }: { q: string; a: string }) {
  ...
  return (
    <div>
      ...
      {open && <p className="pb-6 text-muted-foreground leading-relaxed pr-12">{a}</p>}
    </div>
  );
}
